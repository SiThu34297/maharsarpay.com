...
export const enDictionary: Dictionary = {
  ...
  bookReviewsList: {
    title: "Book Reviews",
    description: "Reader notes and reflections from our community.",
    searchPlaceholder: "Search by author, reviewer, or book name...",
    searchButton: "Search",
    showingResults: "Showing {count} reviews loaded",
    clearAllFilters: "Clear search",
    noReviewsFound: "No reviews found",
    tryDifferentFilters: "Try a different author, reviewer, or book name",
    browseBooks: "Browse Books",
    loadingMore: "Loading more reviews...",
    loadMoreError: "Something went wrong while loading more reviews.",
    retry: "Retry",
    removeFilterLabel: "Remove filter",
    byLabel: "By",
    onLabel: "On",
    reviewedBookLabel: "Reviewed Book",
    readReviewLabel: "Read review",
    viewsLabel: "Views",
  },
  bookReviewDetail: {
    breadcrumbLabel: "Book review breadcrumb",
    breadcrumbBookReviews: "Book Reviews",
    reviewByLabel: "Review by",
    reviewedBookLabel: "Reviewed Book",
    publishedOnLabel: "Published",
    updatedOnLabel: "Updated",
    viewsLabel: "Views",
    openBookLabel: "Open this book",
    backToReviews: "Back to all reviews",
  },
  authorDetail: {
  ...
  contactPage: {
    ...
    subscriptionTitle: "Subscribe to Favorite Authors",
    subscriptionDescription:
      "Tell us the authors you love and we will keep you updated on their new books.",
    authorsLabel: "Favorite authors",
    ...
    requiredFieldsError: "Please fill in favorite authors and phone number.",
    unknownError: "Unable to submit your subscription. Please try again.",
  ...
  cartPage: {
    ...
    townshipLabel: "Township (optional)",
    townshipPlaceholder: "Select township",
    selectProvinceFirst: "Select province first",
    selectCityFirst: "Select city first",
    loadingProvincesText: "Loading provinces...",
    loadingCitiesText: "Loading cities...",
    loadingTownshipsText: "Loading townships...",
    ...
    orderErrorRequiredFields: "Please fill in all required checkout fields.",
    orderErrorFallback: "Unable to place your order. Please try again.",
    orderSuccessMessage: "Order placed successfully. We will contact you soon.",
  },
  loginPage: {
    metaTitle: "Login",
